    ...
    return (
        <div className="flex flex-col gap-8 items-center justify-center mt-12">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-16">
                            ...
                            >
                                ...
                                <div className="flex gap-8">
                                    ...
                                    <div className="flex flex-col justify-between">
                                        <div className="">
                                            <p className="text-sm font-medium flex flex-col gap-8">
                                                {item.name}
                                            </p>
                ...
                {/* DETAILS */}
                <div className="w-full lg:max-w-5/12 shadow-lg border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
